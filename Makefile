...
lint = ruff kohtaaminen test
pytest = pytest --asyncio-mode=strict --cov=kohtaaminen --cov-report term-missing:skip-covered --cov-branch --log-format="%(levelname)s %(message)s"
types = mypy kohtaaminen
